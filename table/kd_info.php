...
if ($data!=null)
  ...
  else {$out='<div style="width: 500px; color:black;">Данные:<br/>Распределение: <br/>Площадка: </div><hr>'; //('<h3>Исходящих данных по этому номеру/абоненту на Дзержинке нет</h3>');
}
}
// $out.='</tr>
//     </tbody>

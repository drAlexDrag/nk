<?php
  ...
  $source_dirs = array();
  // $source_dirs[] = "/openserver/domains/zpp-k136-svyaz.integral.by";
  $source_dirs[] = "/openserver/domains/zpp-k136-svyaz.integral.by";
  // $source_dirs[] = "/home/mysite2.ru";
  

  // $offset_dirs = strlen("/openserver/domains/zpp-k136-svyaz.integral.by");
  $offset_dirs = strlen("/openserver/domains/zpp-k136-svyaz.integral.by"); // Служебная переменная, служащая для устранения лишних папок в архиве
  ...
  if (file_exists($dump_dir_if)) {
   ...
   $output.='<hr><div class="alert alert-info">Проходит первое копирование базы данных</div>';
   $output.='<hr><div class="alert alert-info">Для хранения копий создан каталог '.$dump_dir_if.'</div>';
   //echo "Добавлен каталог ".$dump_dir_if." для хранения копий базы данных и копий сайта";
   $dump_dir = "D:/DUMP/KROSS/";
}
  // $dump_dir = "D:/DUMP/KROSS/";
